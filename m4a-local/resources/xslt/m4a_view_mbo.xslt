    ...
    <a>
        ...
        <xsl:choose>
            <xsl:when test="$sector=@id">
                ...
                <xsl:attribute name="href"><xsl:value-of select="concat('../../../no-sector/',$comp,'/',$subcomp,'/index.html')"/></xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
                <xsl:attribute name="href"><xsl:value-of select="concat('../../../', @id, '/',$comp,'/',$subcomp,'/index.html')"/></xsl:attribute>
